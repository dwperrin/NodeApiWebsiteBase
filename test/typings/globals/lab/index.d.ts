...
// Source: https://raw.githubusercontent.com/garthk/lab-transform-typescript/master/typings-local/lab.d.ts
declare module 'lab' {
    type Callback = {
        (err?: Error): void
    }
    ...
    export type Laboratory = {
        ...
        describe: (description: string, experiment: Experiment) => any
        test: (description: string, test: Test) => any
        it: (description: string, test: Test) => any
